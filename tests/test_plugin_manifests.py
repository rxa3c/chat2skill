...
class PluginManifestTests(unittest.TestCase):
    ...
    def test_deepseek_harness_bundle_declares_lifecycle_adapter(self):
        ...
        self.assertIn("result.recall_context", adapter)
        self.assertIn("result.instructions_context", adapter)
        self.assertIn("form === 'instructions' ? instructionFrame", adapter)
        ...
        self.assertIn("prompt_contexts_for_result", bridge)
        self.assertIn("recall_context", bridge)
        self.assertIn("instructions_context", bridge)
